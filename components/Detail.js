...
const BottomReport =(props)=>{
    ...
    return  <View style={{flex:0.6,alignItems: 'stretch',width:'100%',}}>
        <View style={{width:'100%',height:'15%',alignItems:'center',flexDirection:'column',justifyContent:'center',}}>
            <ButtonGroup buttons={buttons} containerStyle={{width:'70%',height:'40%',borderRadius:0,backgroundColor:'transparent',
            borderWidth:2,borderColor:themeColor,margin:10,borderRightWidth:2,}}
             ...
             selectedButtonStyle={{backgroundColor:'white',borderWidth:0}} innerBorderStyle={{color:'transparent',width:0}} selectedTextStyle={{color:'black'}} 
             onPress={props.SwitchTab} />    
        </View>
        <View>
